...
/**
 * StreamEvent types that should be silently dropped by adapters without
 * sending any message to the user (e.g. internal pipeline bookkeeping events).
 */
export const SILENT_EVENT_TYPES = new Set(['session_status', 'tool_call_start']);
